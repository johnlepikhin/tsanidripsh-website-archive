...
let riza =
	...
	<<
		<div>
			$Tpl_img.text_img ~right:true ~text:"Озеро Рица" Riza riza04$
	...
	<<
		<div>
			...
			$Tpl_img.text_img ~text:"Здесь проводились первые в мире соревнования по скалолазанию" Riza riza02$
			<p>
			...
			$Tpl_img.text_img ~right:true ~text:"На том берегу дача Сталина" Riza riza03$
			<p>
...
let alps =
	...
	<<
		<div>
			$Tpl_img.text_img ~right:true ~text:"Кавказские альпы" Alps alps04$
	...
	<<
		<div>
			...
			$Tpl_img.text_img ~text:"Вид на дорогу" Alps alps02$
			<p>
			...
			$Tpl_img.text_img ~right:true ~text:"Облака винзу" Alps alps09$
			<p>
...
let afon =
	...
	<<
		<div>
			$Tpl_img.text_img ~right:true ~text:"Новоафонский монастырь" Afon afon_abbey02$
			<p>
	...
	<<
		<div>
			$Tpl_img.text_img ~text:"В пещере" Cave cave09$
			<p>
			...
			$Tpl_img.text_img ~text:"Лебединое озеро" Afon afon02$
			<p>
			...
			$Tpl_img.text_img ~right:true ~text:"Кошки и птицы мирно сосуществуют" Afon afon03$
			<p>
			...
			$Tpl_img.text_img ~text:"Железнодорожная станция расположена на прекрасном озере" Afon afon06$
			<p>
			...
			$Tpl_img.text_img ~right:true ~text:"Новоафонский монастырь" Afon afon_abbey01$
			<p>
...
let canyon =
	...
	<<
		<div>
			$Tpl_img.text_img ~right:true ~text:"Панорама каньона" Canyon canyon10$
	...
	<<
		<div>
			$Tpl_img.text_img ~text:"Древний самшитовый лес" Canyon canyon03$
			<p>
			...
			$Tpl_img.text_img ~right:true ~text:"Самое начало каньона" Canyon canyon09$
			<p>
