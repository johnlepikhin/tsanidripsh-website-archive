...
let center = [%html{|
	<div class="tpl_main_center">
		...
		<p>
			Бронирование номеров осуществляется с помощью предоплаты на наш счет в Сбербанке. Сумма составляет 2000 рублей за номер. В дальнейшем, эти деньги пойдут на оплату проживания.
			<b>Внимание! В случае отказа от поездки, сумма предоплаты не возвращается!</b>
