...
let center = <<
	<div class="tpl_main_center">
		...
		<ul>
			...
			<li>Новогодний стол (банкет): <b>1000 руб</b></li>
		</ul>
		<div>
...
include Page.Make (struct
	let title = "Как включить интернет-тариф"

	let contents_name = None

	let path = Purl.make Path.root "internet-instruction-billing"

	let doc () = Tpl.tpl_base_newyear ~position:Tpl.Position.Internet ~title center
end)
