...
let lst = [
	...
	<<
		<div class="prices_main">
			$Tpl_pano360.text_pano360 ~right:true ~text:"В одном из наших номеров (можно развернуть на весь экран!)" Static.pano_room_economic_4beds$
			<p>
			...
			<p>
				Возможны индивидуальные скидки. Предоставляем возможность <a href=$Page_common.url Page.p_billing$>забронировать номер</a> с предварительной оплатой на наш счет в Сбербанке. В дальнейшем бронь пойдет в оплату номера. <b>Внимание! В случае отказа от заселения, бронь не возвращается!</b>
