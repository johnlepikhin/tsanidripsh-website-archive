...
let tbl_food = tbl_price [
	<< <th>Вино, за полтора литра</th> >> :: tbl_row [250];
	<< <th>Чача, за поллитра</th> >> :: tbl_row [200];
	<< <th>Мандариновый сок, за три литра</th> >> :: tbl_row [200];
	<< <th>Сок фейхоа, за три литра</th> >> :: tbl_row [200];
	<< <th>Мандарины, кг</th> >> :: tbl_row [100];
	<< <th>Хурма, кг</th> >> :: tbl_row [100];
	<< <th>Фейхоа, кг</th> >> :: tbl_row [100];
]
