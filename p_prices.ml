...
let lst = [
    ...
    (let pano360 = Tpl_pano360.text_pano360 ~right:true ~text:"В одном из наших номеров (можно развернуть на весь экран!)" Static.pano_room_economic_4beds in
     [%html
         ...
         [pano360]
         "
          <p> Гостевой дом Валента организует частный отдых в малонаселенном местечке Абхазии. Хозяева проживают в поселке в Цандрипш,
         ...
         " году
          ...
          <p> Гостевые дома Цандрипша относятся к территории Большой Гагры. Удобство для посетителей – близость к российской границе.
              ...
              Псоу. Отдых в гостевом доме Гагры в Абхазии запомнится прогулками по городу. Обзор достопримечательностей, посещение единственного
          ...
          <p> Снять жилье в Цандрипше может молодежь, семейные пары с детьми, пожилые люди. В частном секторе Гагрского района комфортно
          ...
          <p>
              Цандрипш приглашает туристов в гостевые дома с качественным домашним сервисом. Оплата
         ...
         "
          ...
          <ul>
              ...
              <li>Доступные цены – снять номер в Абхазии на берегу моря может каждый.</li>
          </ul>
          "
         ...
         "
              ...
              <p>
                  ...
                  отдых. В частном секторе снять дом в Абхазии можно на неделю, месяц, весь летний период
              ...
              <p>
                  ...
                  горы, разнообразие фруктов, общая веранда для вечерних посиделок – для отдыха в
                  Абхазии летом в стоимость включено все необходимое. Гости могут бесплатно пользоваться:
              </p>
              <ul>
         ...
         " и выше.
          ...
          <p>
              ...
              rooms_tour_href
              ">3D-туре по номерам</a>. Он наглядно продемонстрирует, что снять хороший номер в Абхазии недорого – это вполне реально.
