	...
	<<
		<div class="prices_main">
			...
			<p>
				...
				В доме номера <b>стандарт</b> класса. В номерах 1,5 спальные кровати по количеству проживающих, <b>телевизоры</b>, тумбочки, платяные шкафы,
			...
			<ul>
				...
				<li><b>возможность заказать двухразовое питание в нашей столовой ($str:Tpl_prices.to_string Prices.breakfast$ завтрак и $str:Tpl_prices.to_string Prices.dinner$ ужин)</b>;</li>
