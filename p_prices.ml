...
<h3>Спецпредложение: коттедж</h3>
<p>
Спешим предложить новую для Цандрипша услугу: отдельный коттедж! В нём к вашим услугам:
</p>
<ul>
<li>Две спальни, большая гостиная</li>
<li>Отдельный душ и туалет</li>
<li>В доме есть холодильник, микроволновка, чайник, посуда, фен, кондиционер, полотенца</li>
<li>Во дворе коттеджа ваш собственный мангал и столик</li>
</ul>
